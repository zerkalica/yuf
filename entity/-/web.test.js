...
(function ($_1) {
    ...
    (function ($$) {
        $mol_test({
            'user test'($) {
                const talent_dig = $.$gd_core_entity_test_talent.add({
                    id: 't1',
                    title: 'dig',
                    amount: 5,
                });
                const talent_fly = $.$gd_core_entity_test_talent.add({
                    id: 't2',
                    title: 'fly',
                    amount: 15,
                });
                const user = $.$gd_core_entity_test_user.add({
                    id: 'u1',
                    name: '1',
                    age: 22,
                    talent_ids: ['t1']
                });
                const ids = $.$gd_core_entity_test_user.search({}).find(id => id === 'u1');
                $mol_assert_equal(ids, 'u1');
                user.talent_add('t2');
                $mol_assert_equal(user.talent_ids(), ['t1', 't2']);
                user.talent_remove('t1');
                $mol_assert_equal(user.talent_ids(), ['t2']);
                $.$gd_core_entity_test_user.remove('u12');
                const ids_empty = $.$gd_core_entity_test_user.search({});
                $mol_assert_equal(ids_empty, []);
            }
        });
    })($$ = $_1.$$ || ($_1.$$ = {}));
})($ || ($ = {}));
//gd/core/entity/entity.test.ts
;
"use strict";
var $;
(function ($) {
...
var $;
(function ($) {
    class $gd_core_entity_test_talent extends $gd_core_entity {
        defaults() {
            return {
                id: '',
                title: '',
        ...
        title(next) { return this.value('title', next); }
        amount(next) { return this.value('amount', next); }
    }
    $.$gd_core_entity_test_talent = $gd_core_entity_test_talent;
})($ || ($ = {}));
//gd/core/entity/test/talent.ts
;
"use strict";
var $;
(function ($) {
    class $gd_core_entity_test_user extends $gd_core_entity {
        defaults() {
            return {
                id: '',
                name: '',
        ...
        name(next) { return this.value('name', next); }
        age(next) { return this.value('age', next); }
        talent_ids(next) {
            return this.value('talent_ids', next) ?? [];
        }
        talents() {
            return this.talent_ids().map(id => $gd_core_entity_test_talent.factory(id));
        }
        talent_add(id) {
    ...
    __decorate([
        $mol_mem
    ], $gd_core_entity_test_user.prototype, "talent_ids", null);
    __decorate([
        $mol_mem
    ], $gd_core_entity_test_user.prototype, "talents", null);
    __decorate([
        $mol_action
    ], $gd_core_entity_test_user.prototype, "talent_add", null);
    __decorate([
        $mol_action
    ], $gd_core_entity_test_user.prototype, "talent_remove", null);
    $.$gd_core_entity_test_user = $gd_core_entity_test_user;
})($ || ($ = {}));
//gd/core/entity/test/user.ts
